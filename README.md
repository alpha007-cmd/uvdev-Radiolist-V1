...
### **✨ UI Enhancements (New in This Version)**
...
* **Standalone support** – works without any framework
* **RP Name mode** – show ESX / QB player names automatically
...
4. Configure your UI/theme options in `config.lua`
...
You are free to modify and redistribute under GPL-3.0 terms.
